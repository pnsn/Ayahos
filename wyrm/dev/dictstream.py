...
class DictStream(Stream):
    ...
    def __init__(self, traces=None, header={}, **options):
        ...
        self.traces = {}
        # Create an indexing dictionary for sITE-iNST-cOMP
        self.sic_index = {}
        # Create a holder for quick reference to numvers
        self.counts = {'site': 0, 'inst': 0, 'comp': 0}

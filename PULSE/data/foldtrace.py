...
class FoldTrace(Trace):
    ...
    def get_view(self, starttime=None, endtime=None, minfold=0):
    ...
    def extend(self, other, **options):
        ...
        self.apply_inplace_method_to_masked('__add__', other, process_fold=False, **options)

    def stack(self, other, method='avg', **options):
        """Stack two fold traces using a range of operators that are fold-aware

        :param other: _description_
        :type other: _type_
        :param method: _description_, defaults to 'avg'

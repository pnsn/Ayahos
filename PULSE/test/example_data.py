...
def load_townsend_example(base_path):
    ...
    data = data_path / 'PULSE' / 'test' / 'files' / 'uw61965081_PortTownsend_M4.3.mseed'
    stas = data_path / 'PULSE' / 'test' / 'files' / 'uw61965081_Example_Stations.xml'
    even = data_path / 'PULSE' / 'test' / 'files' / 'uw61965081_Origin_Quake.xml'
...
def load_seattle_example(base_path):
    ...
    """    
    data_path = Path(base_path)
    data = data_path / 'PULSE' / 'test' / 'files' / 'uw61956601_Seattle_M2.1.mseed'
    stas = data_path / 'PULSE' / 'test' / 'files' / 'uw61956601_Stations.txt'
    even = data_path / 'PULSE' / 'test' / 'files' / 'uw61956601_Origin_Quake.xml'
    # data = os.path.join('PULSE','test','files','uw61965081_PortTownsend_M4.3.mseed')
    st = read(data)
    inv = read_inventory(stas)
    cat = read_events(even)

...
:purpose:
    ...
    of the :class:`~obspy.core.trace.Trace` class to include.

Classes
-------
:class:`~ewflow.data.trace.Trace`
:class:`~ewflow.data.trace.Buffer`
"""
...
def read_mltrace(data_file, **obspy_read_kwargs):
    ...
    of :meth:`~ewflow.data.mltrace.MLTrace.write` that are associated as
    ...
    :: OUTPUT ::
    :return mlt: [ewflow.data.trace.mltrace.MLTrace] mltrace object
...
class MLStats(Stats):
    ...
    :class:`~ewflow.data.mltrace.MLTrace` class.
    ...
    :type header: dict
    :return: self
    :rtype: ewflow.data.mltrace.MLStats
    """
    ...
    def __init__(self, header={}):
        """Create a :class: `~ewflow.data.mltrace.MLStats object
...
class MLTrace(Trace):
    ...
    def view_copy(self, starttime=None, endtime=None, pad=False, fill_value=None):
        ...
        as a view and then coppied into a new :class: `~ewflow.data.mltrace.MLTrace`
        object.
        ...
        :type fill_value: NoneType, int, float
            also see :meth: `~obspy.core.trace.Trace.trim`
                     :meth: `~ewflow.data.mltrace.MLTrace.trim`
        :return: 
            - **mlt** (*ewflow.data.mltrace.MLTrace*) -- new MLTrace conataining copied data (and fold) information
    ...
    def get_fvalid_subset(self, starttime=None, endtime=None, threshold=1):
        ...
        :type endtime: obspy.core.utcdatetime.UTCDateTime, optional
            also see :meth: `~ewflow.data.mltrace.MLTrace.get_subset_view`
    ...
    def to_zero(self, method='both'):
        ...
        :meth: `~ewflow.data.windowstream.WindowStream.apply_fill_rule`
    ...
    def enforce_zero_mask(self):
        ...
        ..rubric: Toy Example for a :class: `~ewflow.data.mltrace.MLTrace` object 
    ...
    def __repr__(self, id_length=None):
        ...
        :class: `~ewflow.data.mltrace.MLTrace` object
    ...
    def __eq__(self, other):
        ...
        :type other: any, seeking ewflow.data.mltrace.MLTrace
    ...
    def __add__(self, trace, method=1, fill_value=None, sanity_checks=True, dtype=np.float32):
        ...
        :param fill_value: value to fill gaps with, defaults to None
                        also see :meth: `~obspy.core.trace.Trace.__add__`
                                 ...
                                 :meth: `~ewflow.data.mltrace.MLTrace.view_copy`
    ...
    def treat_gaps(self,
        ...
        :param filterkw: keyword arguments to pass to :meth:`~ewflow.data.mltrace.MLTrace.filter`
            also see :meth:`~obspy.core.trace.Trace.filter
        :type filterkw: dict or bool
        :param detrendkw: keyword arguments to pass to :meth:`~ewflow.data.mltrace.MLTrace.detrend`,
        ...
        :param taperkw: keyword arguments to pass to :meth:`~ewflow.data.mltrace.MLTrace.taper`
                    also see :meth:`~obspy.core.trace.Trace.filter
        :type taperkw: dict or bool
        :param mergekw: keyword arguments to pass to :meth:`~ewflow.data.mltrace.MLTrace.merge`
                    also see :meth:`~obspy.core.trace.Trace.filter
        :type mergekw: dict or bool
        :param trimkw: keyword arguments to pass to :meth: `~ewflow.data.mltrace.MLTrace.trim`
                    also see :meth:`~obspy.core.trace.Trace.filter
    ...
    def sync_to_window(self, starttime=None, endtime=None, fill_value=None, pad_after=True, **kwargs):
        ...
        :rtype: ewflow.data.trace.mltrace.MLTrace
    ...
    def read(file_name):
        """
        Read a MSEED file that was generated by :meth:`~ewflow.data.mltrace.MLTrace.write` to reconstitute a new MLTrace object from
    ...
    def get_valid_fraction(self, thresh=1):
        ...
        compare to :meth: `~ewflow.data.mltrace.MLTrace.get_fvalid_subset`

...
#         ist += tr
flist = glob.glob('/Volumes/T7 Shield/GHOST/Passive_Seismic/data/Y2/Row_24/9240/*.2022.*.mseed')
st = obspy.Stream()
for _f in flist:
    st += obspy.read(_f, fmt='mseed')

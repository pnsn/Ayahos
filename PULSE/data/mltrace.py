...
def _add_processing_info(func, *args, **kwargs):
    ...
    in favor of the :class:`~PULSE.data.mlstream.MLStreamStats`-based tracking of 
    processing steps.
    """
    return
...
class MLTrace(Trace):
    ...
    * :meth:`~PULSE.data.mltrace.MLTrace.merge`
    ...
    def _drop_add(gap_mask, overlap_mask, tmp_data_array, tmp_fold_array):
    ...
    def _interp_add(gap_mask, overlap_mask, idx, tmp_data_array, tmp_fold_array):
        """Subroutine for :meth:`~PULSE.data.mltrace.MLTrace.__add__` that replicates the behaviors of
    ...
    def _max_add(gap_mask, tmp_data_array, tmp_fold_array):
    ...
    def _avg_add(gap_mask, tmp_data_array, tmp_fold_array):

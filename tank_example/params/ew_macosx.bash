...
export PULSED_HOME=/Users/nates/Code/PULSED
...
export EW_PARAMS=${PULSED_HOME}/tank_example/params/
export EW_LOG=${PULSED_HOME}/tank_example/log/
export EW_DATA_DIR=${PULSED_HOME}/tank_example/data/

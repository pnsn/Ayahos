...
# Specify Model Architectures, Weights, and Component Aliases
...
# Initialize BufferWyrm elements
buffwyrmEQT = coor.BufferWyrm(
    max_length=200.,
    add_method=3,
    restrict_past_add=False,
    max_pulse_size=1,
    debug=False,

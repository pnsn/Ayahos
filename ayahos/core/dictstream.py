...
def read_mltraces(data_files, obspy_read_kwargs={}, add_options={}):
    """
    Wrapper around the ayahos.data.mltrace.MLTrace.read_mltrace() method
...
class DictStream(Stream):
    ...
    housing for multiple ayahos.core.trace.MLTrace objects and a header object
    ...
    def __init__(self, traces=None, header={}, key_attr='id', **options):
        ...
        :param header: [dict] dict stream header information
                        see ayahos.core.DictStream.DictStreamStats
    ...
    #     DictStream's :class:`ayahos.core.DictStream.DictStreamStats` object.
    #     """
    ...
    def __str__(self):
        rstr = 'ayahos.core.data.DictStream()'
        return rstr
    ...
    def fnselect(self, fnstr, key_attr=None, ascopy=False):
        ...
        :: OUTPUT ::
        :return out: [ayahos.core.DictStream.DictStream] containing
    ...
    def semblance(
        ...
        :param trim_type: [str] how trimming should be conducted using DictStream
                            header information
                            Supported:
        ...
        :: OUTPUT ::
        :return mlt_semb: [ayahos.data.mltrace.MLTrace] (if len(self) > 1)
                MLTrace object with

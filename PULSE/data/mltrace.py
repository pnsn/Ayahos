...
:class:`~PULSE.data.mltrace.Buffer`
"""
...
def read_mltrace(data_file, **obspy_read_kwargs):
    ...
    of :meth:`~PULSE.data.mltrace.MLTrace.write` that are associated as
...
class MLStats(Stats):
    ...
    :type header: dict
    :return: self
    :rtype: PULSE.data.mltrace.MLStats
    """
...
class MLTrace(Trace):
    ...
    def view_copy(self, starttime=None, endtime=None, pad=False, fill_value=None):
        ...
        as a view and then coppied into a new :class: `~PULSE.data.mltrace.MLTrace`
        object.
    ...
    def to_zero(self, method='both'):
        ...
        :meth: `~PULSE.data.windowstream.WindowStream.apply_fill_rule`
    ...
    def __repr__(self, id_length=None):
        ...
        :class: `~PULSE.data.mltrace.MLTrace` object

...
class PredictionWyrm(Wyrm):
    ...
    def run_prediction(self, batch_data, batch_meta):
        """
        ...
        out_shape = (len(batch_meta), len(self.model.labels), self.model.in_samples)
    ...
    def batch2buffer(self, batch_preds, batch_meta, weight_name):
        ...
        for _i, _meta in batch_meta:
            ...
            for _l, label in enumerate(self.model.labels):
